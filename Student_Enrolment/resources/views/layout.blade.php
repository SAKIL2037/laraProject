  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{url('/admin_dashboard')}}"><img src="{{asset('admin/images/salt_logo.svg')}}" alt="Logo"></a>
      </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              <a class="dropdown-item" href="#">
                ...
                <div class="sender">
                  <p class="Sende-name">Sakil Mia</p>
                  <p class="Sender-message">Software Developer</p>
                </div>
              </a>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('tuitionfee')}}">Tuition Fee</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('swe')}}">SWE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('bba')}}">BBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('ece')}}">ECE</a>
                  </li>
                  <li class="nav-item">
